...
They allow pull request authors and reviewers to "Preview" the mConnect Viewer as if
...
The DEPLOY workflow deploys the mConnect Viewer when changes are merged to master.
