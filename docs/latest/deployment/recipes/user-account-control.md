...
- All static resources for mConnect Viewer are unprotected and accessible. We have
...
| ----------------- | ------------------------------------------------ | ------------------------------------------- |
| mConnect Viewer       | [dockerfile][dockerfile] / [config.js][config]   | You're reading them now!                    |
